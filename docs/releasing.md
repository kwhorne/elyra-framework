...
```bash
git tag -a v0.8.0 -m "Elyra Framework v0.8.0 …"
git push origin v0.8.0

gh release create v0.8.0 --title "v0.8.0 — …" --notes-file <(…changelog section…)
```
...
```toml
[dependencies]
elyra = { git = "https://github.com/kwhorne/elyra-framework", tag = "v0.8.0" }
```
...
```json
"@elyra/runtime": "https://github.com/kwhorne/elyra-framework/releases/download/v0.8.0/elyra-runtime-0.8.0.tgz"
```
...
gh release upload v0.8.0 runtime/elyra-runtime-0.8.0.tgz
```
